 ...
 * */
std::array<double, 4> NonlinearVehicleKinematicModel::simulateNonlinearOneStep(const double& desired_velocity,
 ...
 * */
std::array<double, 4> NonlinearVehicleKinematicModel::simulateLinearOneStep(const double& desired_velocity,
		double const& desired_steering)
{
