...
using state_vector_vehicle_t =
    Eigen::Matrix<double, ns_utils::toUType(KinematicErrorDims::STATE_DIM), 1>;
...
using state_vector_observer_t =
    Eigen::Matrix<double, ns_utils::toUType(StateObserverDims::STATE_DIM), 1>;

using input_vector_observer_t =
    Eigen::Matrix<double, ns_utils::toUType(StateObserverDims::INPUT_DIM), 1>;

using state_matrix_observer_t = Eigen::Matrix<
    double, ns_utils::toUType(StateObserverDims::STATE_DIM),
    ns_utils::toUType(StateObserverDims::STATE_DIM)>;

using measurement_vector_observer_t = Eigen::Matrix<
    double, ns_utils::toUType(StateObserverDims::STATE_DIM),
    ns_utils::toUType(StateObserverDims::STATE_DIM)>;

using input_matrix_observer_t = Eigen::Matrix<
    double, ns_utils::toUType(StateObserverDims::INPUT_DIM),
    ns_utils::toUType(StateObserverDims::STATE_DIM)>;

using measurement_matrix_observer_t = Eigen::Matrix<double, ns_utils::toUType(StateObserverDims::MEASUREMENT_DIM),
                                                    ns_utils::toUType(StateObserverDims::STATE_DIM)>;
