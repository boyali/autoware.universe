...
EIGEN_DEFINE_STL_VECTOR_SPECIALIZATION(Eigen::Matrix<double, STATE_DIM, 1>)
EIGEN_DEFINE_STL_VECTOR_SPECIALIZATION(Eigen::Matrix<double, eSTATE_DIM, 1>)
EIGEN_DEFINE_STL_VECTOR_SPECIALIZATION(Eigen::Matrix<double, INPUT_DIM, 1>)
// EIGEN_DEFINE_STL_VECTOR_SPECIALIZATION(Eigen::Matrix<double, PARAM_DIM, 1>)

EIGEN_DEFINE_STL_VECTOR_SPECIALIZATION(Eigen::Matrix<double, STATE_DIM, STATE_DIM>)
EIGEN_DEFINE_STL_VECTOR_SPECIALIZATION(Eigen::Matrix<double, eSTATE_DIM, eSTATE_DIM>)
EIGEN_DEFINE_STL_VECTOR_SPECIALIZATION(Eigen::Matrix<double, INPUT_DIM, INPUT_DIM>)

EIGEN_DEFINE_STL_VECTOR_SPECIALIZATION(Eigen::Matrix<double, eSTATE_DIM, INPUT_DIM>)
EIGEN_DEFINE_STL_VECTOR_SPECIALIZATION(Eigen::Matrix<double, INPUT_DIM, eSTATE_DIM>)

EIGEN_DEFINE_STL_VECTOR_SPECIALIZATION(Eigen::DiagonalMatrix<double, STATE_DIM>)
EIGEN_DEFINE_STL_VECTOR_SPECIALIZATION(Eigen::DiagonalMatrix<double, eSTATE_DIM>)
EIGEN_DEFINE_STL_VECTOR_SPECIALIZATION(Eigen::DiagonalMatrix<double, INPUT_DIM>)

template<int STATE_DIM, int INPUT_DIM, int PARAM_DIM, int eSTATE_DIM>
class VehicleDynamicsBase
{
public:
  // type definitions for C++14.
  ...
  // CppAD variable type definitions.
...
void VehicleDynamicsBase<STATE_DIM, INPUT_DIM, PARAM_DIM, eSTATE_DIM>::InitializeModel()
{
  ...
  x.segment<PARAM_DIM>(STATE_DIM + INPUT_DIM)
  .setConstant(0.05);    // Parameter is the curvature, 1 is singularity.
