...
namespace ns_discretization {
    ...
    public:
        ...
        // If ZOH. V = [x0, A, B0, z]
        using ode_matrix_t =
        typename Eigen::Matrix<double, Model::state_dim, 1 + Model::state_dim + Model::input_dim + 1>;
 ...
 * */
    ...
    public:
        ...
        explicit ODEzoh(
                Model::model_ptr_t model, const Model::input_vector_t &u0,
 ...
 * */
    bool multipleShootingTrajectory(
    ...
    [[maybe_unused]] bool bilinearTransformation(
            Model::model_ptr_t const &model_ptr, trajectory_data_t const &trajectory_data,
 ...
 * */
    ...
    bool bilinearTransformationOneStep(
            Model::model_ptr_t const &model_ptr, Model::state_vector_t const &x0,
            Model::input_vector_t const &u0, Model::param_vector_t const &params0, double const &dt,
            Model::state_matrix_t &Ad, Model::control_matrix_t &Bd);
