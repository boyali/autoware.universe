 ...
 * */
    ...
    bool OptimizationProblemOSQP<STATE_DIM, INPUT_DIM, K>::updateOSQP(
        ...
        auto const &xref_hat =
                ...
                (target_references.X[K - 1] * data_nmpc.feedforward_speed_set_point_scale -
        ...
        std::copy(
                triplets_Aequality_jerk_.cbegin(), triplets_Aequality_jerk_.cend(),
 ...
 * */
    ...
    void OptimizationProblemOSQP<STATE_DIM, INPUT_DIM, K>::getSolution(
        ...
        for (size_t k = 0; k < K; ++k) {  // counts until k = K-1
            auto const &&xsolk =
