...
namespace ns_sim {
    ...
    public:
        ...
        explicit ODEfoh(
                Model::model_ptr_t const &model, const Model::input_vector_t &u0,
    ...
    public:
        ...
        explicit ODEvariableSpeed(
                Model::model_ptr_t const &model, Model::input_vector_t const &u0,
    ...
    * */
    void simulateNonlinearModel_zoh(
            Model::model_ptr_t model, Model::input_vector_t const &u0, Model::param_vector_t const &params,
            const double &dt, Model::state_vector_t &x);
    ...
    void simulateNonlinearModel_variableSpeed(
            Model::model_ptr_t model, Model::input_vector_t const &u0, Model::param_vector_t const &params0,
            double const &v0, double const &v1, const double &dt, Model::state_vector_t &x);
