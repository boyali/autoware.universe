 ...
 * @param xy0 All trajectories in the optimization space start from zero. xy0 is added back to move
 * from optimization space to the Autoware space. The states stored in the trajectory_data.X are
