...
#ifndef UTILS__NMPC_UTILS_EIGEN_HPP_
#define UTILS__NMPC_UTILS_EIGEN_HPP_
											...
											Eigen::MatrixBase<Derived2> &Xtobesolved, char type_of_R)
{
	...
	// printEigenMat(Eigen::Matrix<T, Eigen::Dynamic, Eigen::Dynamic>(R));
}
 ...
 */
template<typename T, class Derived1, class Derived2>
void cholesky_update(Eigen::MatrixBase<Derived1> &R,
