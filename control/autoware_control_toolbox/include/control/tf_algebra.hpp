...
/**
 * @brief Structs equipped with polynomial addition and multiplication property for the denominator
 * and numerator operations of the transfer function objects.
 * */
