...
private:
  ...
  {
    // path shape change
    double min_dist_for_path_shape_change;
    double min_yaw_for_path_shape_change;

    // path goal change
    double min_cropped_path_length;
    double delta_dist_for_path_goal_change;

    double min_ego_moving_dist;

    double min_time_sec_for_replan;
  };
