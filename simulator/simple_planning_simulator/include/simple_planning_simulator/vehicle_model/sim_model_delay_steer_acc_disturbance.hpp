...
#ifndef SIMPLE_PLANNING_SIMULATOR_SIM_MODEL_DELAY_STEER_ACC_DISTURBANCE_H
#define SIMPLE_PLANNING_SIMULATOR_SIM_MODEL_DELAY_STEER_ACC_DISTURBANCE_H
...
public:
	 ...
	 */
	SimModelDelaySteerAcc_Dist(float64_t vx_lim,
			float64_t steer_lim,
	 ...
	 */
	//  ~SimModelDelaySteerAcc_Dist() = default;
...
#endif //SIMPLE_PLANNING_SIMULATOR_SIM_MODEL_DELAY_STEER_ACC_DISTURBANCE_H
