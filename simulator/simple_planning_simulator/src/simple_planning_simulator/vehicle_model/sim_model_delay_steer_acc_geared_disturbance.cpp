...
#include "simple_planning_simulator/vehicle_model/sim_model_delay_steer_acc_geared_disturbance.hpp"
...
float64_t SimModelDelaySteerAccGeared::getX()
{ return state_(IDX::X); }
float64_t SimModelDelaySteerAccGeared::getY()
{ return state_(IDX::Y); }
float64_t SimModelDelaySteerAccGeared::getYaw()
{ return state_(IDX::YAW); }
float64_t SimModelDelaySteerAccGeared::getVx()
{ return state_(IDX::VX); }
float64_t SimModelDelaySteerAccGeared::getVy()
{ return 0.0; }
float64_t SimModelDelaySteerAccGeared::getAx()
{ return state_(IDX::ACCX); }
float64_t SimModelDelaySteerAccGeared::getWz()
{
  return state_(IDX::VX) * std::tan(state_(IDX::STEER)) / wheelbase_;
}
float64_t SimModelDelaySteerAccGeared::getSteer()
