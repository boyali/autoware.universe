...
float64_t SimModelDelaySteerAcc::getX()
{ return state_(IDX::X); }
float64_t SimModelDelaySteerAcc::getY()
{ return state_(IDX::Y); }
float64_t SimModelDelaySteerAcc::getYaw()
{ return state_(IDX::YAW); }
float64_t SimModelDelaySteerAcc::getVx()
{ return state_(IDX::VX); }
float64_t SimModelDelaySteerAcc::getVy()
{ return 0.0; }
float64_t SimModelDelaySteerAcc::getAx()
{ return state_(IDX::ACCX); }
float64_t SimModelDelaySteerAcc::getWz()
{
  return state_(IDX::VX) * std::tan(state_(IDX::STEER)) / wheelbase_;
}
float64_t SimModelDelaySteerAcc::getSteer()
