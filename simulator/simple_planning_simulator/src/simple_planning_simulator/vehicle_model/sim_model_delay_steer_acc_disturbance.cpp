...
SimModelDelaySteerAcc_Disturbance::SimModelDelaySteerAcc_Disturbance(float64_t vx_lim,
                                                                     float64_t steer_lim,
...
float64_t SimModelDelaySteerAcc_Disturbance::getX()
{ return state_(IDX::X); }

float64_t SimModelDelaySteerAcc_Disturbance::getY()
{ return state_(IDX::Y); }

float64_t SimModelDelaySteerAcc_Disturbance::getYaw()
{ return state_(IDX::YAW); }

float64_t SimModelDelaySteerAcc_Disturbance::getVx()
{ return state_(IDX::VX); }

float64_t SimModelDelaySteerAcc_Disturbance::getVy()
{ return 0.0; }

float64_t SimModelDelaySteerAcc_Disturbance::getAx()
...
float64_t SimModelDelaySteerAcc_Disturbance::getSteer()
