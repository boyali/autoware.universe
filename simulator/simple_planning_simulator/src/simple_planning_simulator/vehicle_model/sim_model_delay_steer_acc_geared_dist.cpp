...
SimModelDelaySteerAccGeared_Dist::SimModelDelaySteerAccGeared_Dist(float64_t vx_lim,
		float64_t steer_lim,
...
float64_t SimModelDelaySteerAccGeared_Dist::getY()
{
	return state_(IDX::Y);
}

float64_t SimModelDelaySteerAccGeared_Dist::getYaw()
{
	return state_(IDX::YAW);
}

float64_t SimModelDelaySteerAccGeared_Dist::getVx()
{
	return state_(IDX::VX);
}

float64_t SimModelDelaySteerAccGeared_Dist::getVy()
{
	return 0.0;
}

float64_t SimModelDelaySteerAccGeared_Dist::getAx()
{
...
float64_t SimModelDelaySteerAccGeared_Dist::getSteer()
{
...
void SimModelDelaySteerAccGeared_Dist::updateStateWithGear(Eigen::VectorXd& state,
