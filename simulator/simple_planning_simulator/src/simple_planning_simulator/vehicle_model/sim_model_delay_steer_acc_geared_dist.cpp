...
#include "simple_planning_simulator/vehicle_model/sim_model_delay_steer_acc_geared_dist.hpp"

#include "autoware_auto_vehicle_msgs/msg/gear_command.hpp"

#include <algorithm>

SimModelDelaySteerAccGeared_Dist::SimModelDelaySteerAccGeared_Dist(
...
float64_t SimModelDelaySteerAccGeared_Dist::getX() { return state_(IDX::X); }

float64_t SimModelDelaySteerAccGeared_Dist::getY() { return state_(IDX::Y); }

float64_t SimModelDelaySteerAccGeared_Dist::getYaw() { return state_(IDX::YAW); }

float64_t SimModelDelaySteerAccGeared_Dist::getVx() { return state_(IDX::VX); }

float64_t SimModelDelaySteerAccGeared_Dist::getVy() { return 0.0; }

float64_t SimModelDelaySteerAccGeared_Dist::getAx() { return state_(IDX::ACCX); }

float64_t SimModelDelaySteerAccGeared_Dist::getWz()
{
  return state_(IDX::VX) * std::tan(state_(IDX::STEER)) / wheelbase_;
}

float64_t SimModelDelaySteerAccGeared_Dist::getSteer() { return state_(IDX::STEER); }

void SimModelDelaySteerAccGeared_Dist::update(const float64_t & dt)
{
...
Eigen::VectorXd SimModelDelaySteerAccGeared_Dist::calcModel(
...
void SimModelDelaySteerAccGeared_Dist::updateStateWithGear(
